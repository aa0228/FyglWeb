	...
	<form id="loginForm" action="login.do" method="post">
		<div class="main-div">
			...
			<a class="error" style="display: none;float:right;"></a>
              ...
              <!--   <option value="120000 200" selected>天津市高级人民法院</option>-->
          ...
          <div class="bottom-div">
				<p style="margin: 20px 35px 20px 28px;">
				   <span style="float: left;">
					<input type="checkbox" id="reme" class="reme" /> <label for="reme" class="reme-lable">记住密码</label></span>
						</span>
...
<script type="text/javascript">
    $(function() {
        if ($.cookie("username") != null) {
            ...
            $("input[name='bmbhselectname']").val($.cookie("bmbhselectname"));
    ...
    $("#loginButton").click(function(e) {
        ...
        var bmbhselectname= $("input[name='bmbhselectname']").val();
        $.ajax({
            url : "login.aj",
            type : "get",
            dataType : "json",
            data : {
                username : username,
                password : password,
                bmbhselectname:bmbhselectname
            },
            success : function(result) {
                if (result[0] == "success") {
                    if ($("input[type='checkbox']").prop("checked")) {
                        $.cookie("username", username, 30);
                        $.cookie("password", password, 30);
                    } else {
